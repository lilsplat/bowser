...
class ArchivedCourseSpider(scrapy.Spider):
    name = "archived_course_spider"
    profwriter=open('professors.txt','w+')
    tdwriter=open('timeanddate.txt','w+')
    ...
    #change from /tutorial to /bowserbot
        ...
        "file:///Users/lilian/Documents/2014/GitHub/bowser/scrapy/bowserbot/course_browser_htmls/201407.txt", 
