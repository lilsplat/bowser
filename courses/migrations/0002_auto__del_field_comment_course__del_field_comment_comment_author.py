...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Comment.comment_author'
        db.delete_column(u'courses_comment', 'comment_author_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Comment.comment_author'
        db.add_column(u'courses_comment', 'comment_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Student']),
                      keep_default=False)
