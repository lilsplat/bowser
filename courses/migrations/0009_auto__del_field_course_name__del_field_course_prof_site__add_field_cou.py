...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Course.prof_site'
        db.delete_column(u'courses_course', 'prof_site')
        ...
        db.add_column(u'courses_course', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Course.credit_hours'
        db.add_column(u'courses_course', 'credit_hours',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
        ...
        # Adding field 'Course.addit_info'
        db.add_column(u'courses_course', 'addit_info',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
        ...
        # Adding field 'Course.by_permission'
        db.add_column(u'courses_course', 'by_permission',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Course.prereq'
        db.add_column(u'courses_course', 'prereq',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Course.notes'
        db.add_column(u'courses_course', 'notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Course.xlisted'
        db.add_column(u'courses_course', 'xlisted',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Course.prof_site'
        db.add_column(u'courses_course', 'prof_site',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
        ...
        db.delete_column(u'courses_course', 'title')

        # Deleting field 'Course.credit_hours'
        db.delete_column(u'courses_course', 'credit_hours')

        # Deleting field 'Course.description'
        db.delete_column(u'courses_course', 'description')

        # Deleting field 'Course.addit_info'
        db.delete_column(u'courses_course', 'addit_info')
        ...
        # Deleting field 'Course.by_permission'
        db.delete_column(u'courses_course', 'by_permission')

        # Deleting field 'Course.prereq'
        db.delete_column(u'courses_course', 'prereq')

        # Deleting field 'Course.notes'
        db.delete_column(u'courses_course', 'notes')

        # Deleting field 'Course.xlisted'
        db.delete_column(u'courses_course', 'xlisted')
