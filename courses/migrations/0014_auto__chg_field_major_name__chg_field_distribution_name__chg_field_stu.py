...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'courses_major', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Distribution.name'
        db.alter_column(u'courses_distribution', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Student.class_year'
        db.alter_column(u'courses_student', 'class_year', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Major.name'
        db.alter_column(u'courses_major', 'name', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Distribution.name'
        db.alter_column(u'courses_distribution', 'name', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Student.class_year'
        db.alter_column(u'courses_student', 'class_year', self.gf('django.db.models.fields.CharField')(max_length=5))
