...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.dist'
        db.delete_column(u'courses_course', 'dist_id')
    ...
    def backwards(self, orm):
        # Adding field 'Course.dist'
        db.add_column(u'courses_course', 'dist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 7, 14, 0, 0), related_name='distribution', to=orm['courses.Distribution']),
                      keep_default=False)
