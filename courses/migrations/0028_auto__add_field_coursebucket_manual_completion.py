...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseBucket.manual_completion'
        db.add_column(u'courses_coursebucket', 'manual_completion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseBucket.manual_completion'
        db.delete_column(u'courses_coursebucket', 'manual_completion')
