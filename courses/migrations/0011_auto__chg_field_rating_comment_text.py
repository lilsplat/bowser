...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.comment_text'
        db.alter_column(u'courses_rating', 'comment_text', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

    def backwards(self, orm):

        # Changing field 'Rating.comment_text'
        db.alter_column(u'courses_rating', 'comment_text', self.gf('django.db.models.fields.CharField')(default='', max_length=10000))
