...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course_Bucket.num_pick'
        db.add_column(u'courses_course_bucket', 'num_pick',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course_Bucket.num_pick'
        db.delete_column(u'courses_course_bucket', 'num_pick')
