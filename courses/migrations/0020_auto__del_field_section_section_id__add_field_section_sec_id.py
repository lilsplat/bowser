...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Section.section_id'
        db.delete_column(u'courses_section', 'section_id')

        # Adding field 'Section.sec_id'
        db.add_column(u'courses_section', 'sec_id',
                      self.gf('django.db.models.fields.CharField')(default='None assigned', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Section.section_id'
        db.add_column(u'courses_section', 'section_id',
                      self.gf('django.db.models.fields.CharField')(default='None assigned', max_length=200),
                      keep_default=False)

        # Deleting field 'Section.sec_id'
        db.delete_column(u'courses_section', 'sec_id')
