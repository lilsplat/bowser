...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'courses_rating', 'name')

        # Adding field 'Rating.comment_text'
        db.add_column(u'courses_rating', 'comment_text',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'courses_rating', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10000),
                      keep_default=False)

        # Deleting field 'Rating.comment_text'
        db.delete_column(u'courses_rating', 'comment_text')
