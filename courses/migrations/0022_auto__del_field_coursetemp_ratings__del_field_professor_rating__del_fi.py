...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseTemp.ratings'
        db.delete_column(u'courses_coursetemp', 'ratings_id')

        # Deleting field 'Professor.rating'
        db.delete_column(u'courses_professor', 'rating_id')

        # Deleting field 'Section.course_id'
        db.delete_column(u'courses_section', 'course_id_id')

        # Adding field 'Section.course'
        db.add_column(u'courses_section', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.CourseTemp']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CourseTemp.ratings'
        db.add_column(u'courses_coursetemp', 'ratings',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Rating']),
                      keep_default=False)

        # Adding field 'Professor.rating'
        db.add_column(u'courses_professor', 'rating',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Rating']),
                      keep_default=False)

        # Adding field 'Section.course_id'
        db.add_column(u'courses_section', 'course_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['courses.CourseTemp']),
                      keep_default=False)
    ...
    models = {
        ...
        u'courses.section': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['courses.CourseTemp']"}),
