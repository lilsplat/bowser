...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course_Bucket.major'
        db.add_column(u'courses_course_bucket', 'major',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Major']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course_Bucket.major'
        db.delete_column(u'courses_course_bucket', 'major_id')
