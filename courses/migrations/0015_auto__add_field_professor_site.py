...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Professor.site'
        db.add_column(u'courses_professor', 'site',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Professor.site'
        db.delete_column(u'courses_professor', 'site')
    ...
    models = {
        ...
        u'courses.timeanddate': {
            'Meta': {'ordering': "['name']", 'object_name': 'TimeAndDate'},
