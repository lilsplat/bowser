...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Student', fields ['username']
        db.create_unique(u'courses_student', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'Student', fields ['username']
        db.delete_unique(u'courses_student', ['username'])
