...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.semseter'
        db.delete_column(u'courses_course', 'semseter_id')

        # Adding M2M table for field semseter on 'Course'
        m2m_table_name = db.shorten_name(u'courses_course_semseter')
    ...
    def backwards(self, orm):
        # Adding field 'Course.semseter'
        db.add_column(u'courses_course', 'semseter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Semester']),
                      keep_default=False)

        # Removing M2M table for field semseter on 'Course'
        db.delete_table(db.shorten_name(u'courses_course_semseter'))
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'semseter': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['courses.Semester']", 'symmetrical': 'False'}),
