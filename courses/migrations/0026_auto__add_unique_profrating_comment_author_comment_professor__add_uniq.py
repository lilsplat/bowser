...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProfRating', fields ['comment_author', 'comment_professor']
        db.create_unique(u'courses_profrating', ['comment_author_id', 'comment_professor_id'])

        # Adding unique constraint on 'CourseRating', fields ['comment_author', 'comment_course']
        db.create_unique(u'courses_courserating', ['comment_author_id', 'comment_course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseRating', fields ['comment_author', 'comment_course']
        db.delete_unique(u'courses_courserating', ['comment_author_id', 'comment_course_id'])

        # Removing unique constraint on 'ProfRating', fields ['comment_author', 'comment_professor']
        db.delete_unique(u'courses_profrating', ['comment_author_id', 'comment_professor_id'])
    ...
    models = {
        ...
        u'courses.courserating': {
            'Meta': {'unique_together': "(('comment_author', 'comment_course'),)", 'object_name': 'CourseRating'},
        ...
        u'courses.profrating': {
            'Meta': {'unique_together': "(('comment_author', 'comment_professor'),)", 'object_name': 'ProfRating'},
            'comment_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['courses.Student']"}),
