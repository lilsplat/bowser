...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.multi_passed'
        db.add_column(u'courses_student', 'multi_passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.multi_passed'
        db.delete_column(u'courses_student', 'multi_passed')
