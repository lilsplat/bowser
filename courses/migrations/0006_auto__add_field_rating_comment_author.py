...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rating.comment_author'
        db.add_column(u'courses_rating', 'comment_author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Student']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rating.comment_author'
        db.delete_column(u'courses_rating', 'comment_author_id')
