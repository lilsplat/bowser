...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProfRating.comment_course'
        db.delete_column(u'courses_profrating', 'comment_course_id')

        # Adding field 'ProfRating.comment_professor'
        db.add_column(u'courses_profrating', 'comment_professor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Professor']),
                      keep_default=False)

        # Deleting field 'CourseRating.comment_professor'
        db.delete_column(u'courses_courserating', 'comment_professor_id')

        # Adding field 'CourseRating.comment_course'
        db.add_column(u'courses_courserating', 'comment_course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProfRating.comment_course'
        db.add_column(u'courses_profrating', 'comment_course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Course']),
                      keep_default=False)

        # Deleting field 'ProfRating.comment_professor'
        db.delete_column(u'courses_profrating', 'comment_professor_id')

        # Adding field 'CourseRating.comment_professor'
        db.add_column(u'courses_courserating', 'comment_professor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['courses.Professor']),
                      keep_default=False)

        # Deleting field 'CourseRating.comment_course'
        db.delete_column(u'courses_courserating', 'comment_course_id')
