...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RandomClass'
        db.create_table(u'courses_randomclass', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'courses', ['RandomClass'])


    def backwards(self, orm):
        # Deleting model 'RandomClass'
        db.delete_table(u'courses_randomclass')
    ...
    models = {
        ...
        u'courses.randomclass': {
            'Meta': {'object_name': 'RandomClass'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'courses.student': {
