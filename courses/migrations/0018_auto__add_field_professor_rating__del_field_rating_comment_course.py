...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rating.comment_course'
        db.delete_column(u'courses_rating', 'comment_course_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Rating.comment_course'
        db.add_column(u'courses_rating', 'comment_course',
